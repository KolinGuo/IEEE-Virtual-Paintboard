...
void writeCommand(unsigned char c) {
    ...
    // Set to write command mode
    GPIOPinWrite(GPIOA0_BASE, 0x40, 0x00);      // Set DC to low
    GPIOPinWrite(GPIOA0_BASE, 0x80, 0x00);      // Set OLEDCS to low
    ...
    // Set to write command mode
    GPIOPinWrite(GPIOA0_BASE, 0x80, 0x80);      // Set OLEDCS to high
}
...
void writeData(unsigned char c) {
    ...
    // Set to write command mode
    GPIOPinWrite(GPIOA0_BASE, 0x40, 0x40);      // Set DC to high
    GPIOPinWrite(GPIOA0_BASE, 0x80, 0x00);      // Set OLEDCS to low
