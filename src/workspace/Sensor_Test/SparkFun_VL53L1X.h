...
{
	public:
    //Constructs our Distance sensor without an interrupt or shutdown pin
	SFEVL53L1X(uint32_t i2cBase = I2CA0_BASE, unsigned long shutdownPinPort = 0, unsigned char shutdownPin = 0,
	           unsigned long interruptPinPort = 0, unsigned char interruptPin = 0);
	...
	private:
	uint32_t _i2cBase;
	unsigned long _shutdownPinPort;
	unsigned char _shutdownPin;
	unsigned long _interruptPinPort;
