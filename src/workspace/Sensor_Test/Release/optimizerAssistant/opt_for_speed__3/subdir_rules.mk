...
SparkFun_VL53L1X.obj: ../SparkFun_VL53L1X.cpp $(GEN_OPTS) | $(GEN_HDRS)
	...
	"D:/ti/ccs800/ccsv8/tools/compiler/ti-cgt-arm_18.12.1.LTS/bin/armcl" -mv7M4 --code_state=16 --float_support=none -me --opt_for_speed=3 --include_path="D:/ti/ccs800/ccsv8/tools/compiler/ti-cgt-arm_18.12.1.LTS/include" --include_path="D:/ti/CC3200SDK/CC3200SDK_1.3.0/cc3200-sdk/example/common" --include_path="D:/ti/CC3200SDK/CC3200SDK_1.3.0/cc3200-sdk/driverlib" --include_path="D:/ti/CC3200SDK/CC3200SDK_1.3.0/cc3200-sdk/inc" --define=ccs --define=NON_NETWORK --define=cc3200 -g --diag_warning=225 --diag_wrap=off --display_error_number --abi=eabi --preproc_with_compile --preproc_dependency="SparkFun_VL53L1X.d_raw" $(GEN_OPTS__FLAG) "$<"
