...
SFEVL53L1X::SFEVL53L1X(uint32_t i2cBase, unsigned long shutdownPinPort, unsigned char shutdownPin,
                       unsigned long interruptPinPort, unsigned char interruptPin)
{
	_i2cBase = i2cBase;
	_shutdownPinPort = shutdownPinPort;
	_shutdownPin = shutdownPin;
	_interruptPinPort = interruptPinPort;
	_interruptPin = interruptPin;
	_device = new VL53L1X(i2cBase, shutdownPinPort, shutdownPin, interruptPinPort, interruptPin);
}
...
{
	if(_shutdownPinPort > 0)
	    GPIOPinWrite(_shutdownPinPort, _shutdownPin, _shutdownPin);
...
{
    if(_shutdownPinPort > 0)
        GPIOPinWrite(_shutdownPinPort, _shutdownPin, 0);
